...
@Component
@Lazy
public class GeneradorMultiplicativoFxController implements Initializable {
    ...
    public void aceptarParametros(ActionEvent event) {
        ...
        parametrosSecretaria.setMetodoGeneradorRandom(ConstantesGenerador.MULTIPLICATIVO);
        parametrosTecnico.setMetodoGeneradorRandom(ConstantesGenerador.MULTIPLICATIVO);
        parametrosLlegadasEstudio.setMetodoGeneradorRandom(ConstantesGenerador.MULTIPLICATIVO);
        parametrosLlegadasTurno.setMetodoGeneradorRandom(ConstantesGenerador.MULTIPLICATIVO);
