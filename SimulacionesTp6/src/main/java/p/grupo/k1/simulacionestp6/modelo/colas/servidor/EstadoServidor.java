...
public class EstadoServidor {
    ...
    public static final String SERVIDOR_BLOQUEADO = "Bloqueado";
    ...
    public static EstadoServidor getInstanceServidorBloqueado(){
        inicializarMap();
        if(!estadosPosiblesServidor.containsKey(SERVIDOR_BLOQUEADO)){
            estadosPosiblesServidor.put(SERVIDOR_BLOQUEADO, new EstadoServidor(SERVIDOR_BLOQUEADO));
        }
        return estadosPosiblesServidor.get(SERVIDOR_BLOQUEADO);
    }
    ...
    public boolean estadoBloqueado() {
        return estado.equals(EstadoServidor.SERVIDOR_BLOQUEADO);
    }
}
