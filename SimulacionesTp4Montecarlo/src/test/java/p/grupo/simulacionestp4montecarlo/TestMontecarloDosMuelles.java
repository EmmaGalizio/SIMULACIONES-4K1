...
@SpringBootTest
public class TestMontecarloDosMuelles {
    ...
    public void testMontecarlo(){
        ...
        ParametrosCambioDistribucion parametrosCambioDistribucion = parametrosCambioDistribucion();
        ...
        List<VectorEstadoMontecarloPuerto> simulacionPuerto =
                controladorTp4.generarSimulacionDosPuertos(parametrosCambioDistribucion
    ...
    private ParametrosCambioDistribucion parametrosCambioDistribucion(){
